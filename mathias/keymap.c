 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |Adjust| LGUI | LAlt/| Bksp | Ctrl |  | Alt  | Space| AltGr| RGUI | Menu |
 *                        |      |      | Enter|      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_QWERTY] = LAYOUT(
     ...
     CTL_ESC, KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LBRC,KC_CAPS,     FKEYS  , KC_RBRC, KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, ALT_ENT,
                                 ADJUST, KC_LGUI, KC_LSFT, KC_BSPC,MOD_LCTL,   MOD_LALT, KC_SPC ,KC_RALT, KC_RGUI, KC_APP
    ),
 ...
 */
    [_DVORAK] = LAYOUT(
     ...
     KC_LSFT , KC_A ,  KC_O   ,  KC_E  ,   KC_U ,   KC_I ,                                        KC_D,   KC_H ,  KC_T ,   KC_N ,  KC_S , CTL_MINS,
     CTL_ESC,KC_SCLN, KC_Q   ,  KC_J  ,   KC_K ,   KC_X , KC_LBRC,KC_CAPS,     FKEYS  , KC_RBRC, KC_B,   KC_M ,  KC_W ,   KC_V ,  KC_Z , ALT_ENT,
                                 ADJUST, KC_LGUI, KC_LSFT, KC_BSPC,MOD_LCTL,   MOD_LALT, KC_SPC ,KC_RALT, KC_RGUI, KC_APP
    ),
 ...
 */
    [_COLEMAK_DH] = LAYOUT(
     ...
     CTL_ESC, KC_Z ,  KC_X   ,  KC_C  ,   KC_D ,   KC_V ,KC_LBRC,KC_CAPS,      FKEYS  , KC_RBRC, KC_K,   KC_H ,KC_COMM, KC_DOT ,KC_SLSH, ALT_ENT,
                                 ADJUST, KC_LGUI, KC_LSFT, KC_BSPC,MOD_LCTL,   MOD_LALT, KC_SPC ,KC_RALT, KC_RGUI, KC_APP
    ),
